      ...
      function sendConfirmationEmail(status, application, done) {
        ...
        seneca.act({role: plugin, cmd: 'getEvent', id:application.event_id}, function (err, response) {
          ...
          if(event.dates.length > 1) {
            ...
            var code = 'recurring-event-application-received-' + locality.toLowerCase();
            var templates = {};
            ...
            try {
              ...
              code = 'recurring-event-application-received-' + DEFAULT_LANG;
            }
            ...
            var locality = args.locality || 'en_us';
            var code = 'one-off-event-application-received-' + locality.toLowerCase();
            var templates = {};
            ...
            try {
              ...
              code = 'one-off-event-application-received-' + DEFAULT_LANG;
            }
