...
function bulkApplyApplications (args, callback) {
  ...
  function generateEmailContent (applications, done) {
    ...
    function sendApplicantsEmail (profiles, event, session, dojo, tickets, emailCode, dojoEmailCode, done) {
      process.nextTick(function () {
        ...
        async.eachSeries(profiles, function (profile, cb) {
          ...
          //email payload for children and parents
          var payload = {
    ...
    function sendDojoEmail (profiles, event, session, dojo, tickets, emailCode, dojoEmailCode, done) {
      process.nextTick(function () {
