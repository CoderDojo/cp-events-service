...
var releaseTickets = require('./release-tickets');
var isTicketingAdmin = require('./perm/is-ticketing-admin');
var updateReleaseTickets = require('./update-release-tickets');
...
module.exports = function () {
  ...
  seneca.add({role: plugin, cmd: 'updateReleaseTickets'}, updateReleaseTickets.bind(seneca));

  // CRUD
  seneca.add({role: plugin, entity: 'invite', cmd: 'list'}, require('./entity/invite/list'));

  // PERMS
  seneca.add({role: plugin, cmd: 'releaseTickets'}, releaseTickets.bind(seneca));
